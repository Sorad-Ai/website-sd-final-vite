...
import { ArrowRight, Calendar, MapPin, Users, Bell, FileText, Camera, MessageSquare, BarChart3, BookOpen, Clock, Shield, Bus, Zap, Target, TrendingUp, Star } from "lucide-react";
  ...
  const keyFeatures = [
    {
      ...
      description: "उपस्थिति व्यवस्थापन - Smart digital attendance tracking with real-time reporting",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: <Calendar className="w-8 h-8" />,
      title: "Nepali Calendar Integration",
      description: "नेपाली क्यालेन्डर - Full support for Bikram Sambat with festival dates",
      color: "from-green-500 to-green-600"
    },
    {
      icon: <Bus className="w-8 h-8" />,
      title: "Bus Live Tracking",
      description: "बस ट्र्याकिङ - Real-time GPS tracking for student transportation safety",
  ...
  const benefits = [
    {
      ...
      description: "विद्यालय संचालन सुव्यवस्थित - Reduce administrative workload by 70%"
    },
    {
      icon: <Target className="w-6 h-6" />,
      title: "Enhanced Communication", 
      description: "संचार सुधार - Better parent-school communication and engagement"
    },
    {
      icon: <TrendingUp className="w-6 h-6" />,
      title: "Data-Driven Decisions",
      description: "डाटा आधारित निर्णय - Make informed decisions with comprehensive analytics"
    },
    {
      icon: <Star className="w-6 h-6" />,
      title: "Cost Effective",
      description: "लागत प्रभावी - Significant reduction in paper-based processes"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
            ...
            <div className="grid lg:grid-cols-2 gap-20 items-center">
              <div className="scroll-animate">
                <div className="inline-flex items-center px-4 py-2 bg-blue-50 rounded-full mb-6">
                  <span className="text-blue-600 font-semibold text-sm">✨ Complete Solution</span>
                </div>
                ...
                <p className="text-xl text-gray-600 mb-10 leading-relaxed">
                  Our software integrates all aspects of school management into one unified platform. 
                  From student enrollment to graduation, manage everything efficiently with features 
                  tailored for Nepali educational institutions.
                </p>
                
                <div className="space-y-6">
                  {benefits.map((benefit, index) => (
                    <div key={index} className={`flex items-start space-x-4 scroll-animate bg-gradient-to-r from-gray-50 to-transparent p-4 rounded-xl hover:from-blue-50 hover:to-purple-50 transition-all duration-300`}>
                    ...
                    <div className="space-y-8">
                      ...
                      <div className="grid grid-cols-2 gap-6">
                        ...
                        <div className="text-center p-6 bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl hover:from-purple-100 hover:to-purple-200 transition-all duration-300 cursor-pointer">
                          <div className="text-4xl font-bold text-purple-600 mb-2">56</div>
                        ...
                        <div className="p-6 bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl hover:from-green-100 hover:to-emerald-100 transition-all duration-300 cursor-pointer">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-3">
                              ...
                              <span className="font-bold text-green-700">Today's Attendance</span>
                            </div>
                            <span className="text-3xl font-bold text-green-600">96.5%</span>
                          </div>
                        </div>
                        ...
                        <div className="p-6 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-2xl hover:from-blue-100 hover:to-cyan-100 transition-all duration-300 cursor-pointer">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-3">
                              ...
                              <span className="font-bold text-blue-700">Active Buses</span>
                            </div>
                            <span className="text-xl font-bold text-blue-600">12/12 Live</span>
                          </div>
                        </div>
                      </div>
                    </div>
      ...
      <section className="py-24 bg-gradient-to-br from-gray-50 to-blue-50 relative">
        <div className="absolute top-10 right-10 w-64 h-64 bg-gradient-to-br from-blue-200/30 to-purple-200/30 rounded-full blur-3xl"></div>
        ...
        <div className="container mx-auto px-6">
          <div className="scroll-animate text-center mb-20">
            <div className="inline-flex items-center px-6 py-3 bg-white/80 backdrop-blur-sm rounded-full shadow-lg mb-8">
              <span className="text-blue-600 font-semibold">🎯 Key Features</span>
            </div>
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Powerful features designed to address the unique needs of Nepali educational institutions
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
            {keyFeatures.map((feature, index) => (
              <Card key={index} className={`group hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 border-0 transform scroll-animate bg-white/80 backdrop-blur-sm`}>
                <CardContent className="p-8 text-center relative overflow-hidden">
                  ...
                  <div className={`w-20 h-20 mx-auto rounded-3xl bg-gradient-to-r ${feature.color} flex items-center justify-center text-white mb-8 group-hover:scale-110 transition-all duration-300 shadow-lg`}>
                    {feature.icon}
                  </div>
        ...
        <div className="container mx-auto px-6">
          <div className="scroll-animate text-center mb-20">
            <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-50 to-purple-50 rounded-full mb-8">
              <span className="text-blue-600 font-semibold">🌟 Complete Features</span>
            </div>
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Comprehensive feature set designed to transform your school management experience
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
            {allFeatures.map((feature, index) => (
              <Card 
                key={index} 
                className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 border-0 bg-white overflow-hidden scroll-animate relative"
              >
                ...
                <CardContent className="p-8 relative">
                  <div className={`w-24 h-24 rounded-3xl bg-gradient-to-r ${feature.color} flex items-center justify-center text-white mb-8 group-hover:scale-110 transition-all duration-300 shadow-xl`}>
                    {feature.icon}
                  </div>
          ...
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-3 gap-10">
              <div className="text-center scroll-animate">
                ...
                <p className="text-gray-600 leading-relaxed">Enterprise-grade security with 99.9% uptime guarantee. Your data is always safe and accessible.</p>
              </div>
              ...
              <div className="text-center scroll-animate">
                ...
                <p className="text-gray-600 leading-relaxed">Intuitive design that anyone can use without extensive training. Get started in minutes.</p>
              </div>
              ...
              <div className="text-center scroll-animate">
                ...
                <p className="text-gray-600 leading-relaxed">Round-the-clock technical support in Nepali and English. We're here when you need us.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 text-center relative">
          <div className="scroll-animate max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl mb-12 opacity-90 leading-relaxed">
              Join the digital revolution in education. Schedule a demo today and see how 
              Sorad Dynamics can streamline your school operations.
            </p>
