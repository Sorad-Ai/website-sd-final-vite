...
const ServicesSection = () => {
  ...
  return (
    <section id="services" className="py-24 bg-gradient-to-br from-white to-blue-50/30 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mt-20 scroll-animate opacity-0 translate-y-8 transition-all duration-800 ease-out">
            <div className="bg-white/90 backdrop-blur-md rounded-3xl p-10 shadow-2xl border border-white/50 max-w-3xl mx-auto relative overflow-hidden">
              {/* Animated background gradient */}
              <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-blue-500/10 opacity-50 animate-gradient"></div>
              
              <div className="relative z-10">
                <h3 className="text-3xl font-bold text-gray-900 mb-4 animate-gradient bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                  Ready to Transform Your Business?
                </h3>
                <p className="text-gray-600 mb-8 text-lg">
                  Let's discuss how our innovative solutions can accelerate your digital journey.
                </p>
                <button className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-10 py-4 rounded-full font-semibold hover:from-blue-700 hover:to-purple-700 hover:scale-105 transition-all duration-300 shadow-xl hover:shadow-2xl hover:shadow-blue-500/25 relative overflow-hidden group">
                  <span className="relative z-10">Schedule Consultation</span>
                  {/* Neon effect on hover */}
                  <div className="absolute inset-0 bg-gradient-to-r from-blue-400 to-purple-400 opacity-0 group-hover:opacity-30 transition-opacity duration-300 blur-md"></div>
                </button>
              </div>
            </div>
          </div>
